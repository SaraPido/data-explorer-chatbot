...
--
-- Host: localhost    Database: rasa_db
-- ------------------------------------------------------
...
--
-- Current Database: `rasa_db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `rasa_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `Teacher` VALUES (1,'Nicola','Castaldo'),(2,'Maristella','Matera'),(3,'Florian','Daniel'),(4,'Vittorio','Zaccaria'),(5,'Albert','Einstein');
...
-- Dump completed on 2018-11-22 13:05:00
